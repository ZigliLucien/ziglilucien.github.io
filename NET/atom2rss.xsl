...
<x:template match="atom:updated"><dc:date><x:apply-templates/></dc:date></x:template>
<x:template match="atom:published"><pubDate><x:apply-templates/></pubDate></x:template><!-- fix date format -->
