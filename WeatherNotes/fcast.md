<div>
   ...
   <p>
      <div style="font-size:120%">
         <h3>Today</h3>Sunny. High near 88, with temperatures falling to around 85 in the afternoon. North northeast wind 2 to 7 mph.<br></div>
   </p>
   <p>
      <div style="font-size:120%">
         <h3>Tonight</h3>Mostly clear. Low around 60, with temperatures rising to around 62 overnight. Northeast wind 2 to 6 mph.<br></div>
   </p>
   <p>
      <div style="font-size:120%">
         <h3>Wednesday</h3>Mostly sunny. High near 86, with temperatures falling to around 84 in the afternoon. Northeast wind 2 to 6 mph.<br></div>
   </p>
   <p>
      <div style="font-size:120%">
